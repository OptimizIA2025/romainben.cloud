...
window.RB_I18N = {
    ...
    "En parallèle, j'ai co-fondé <strong>OptimizIA.xyz</strong> avec <a href=\"https://www.ginoux.xyz\" target=\"_blank\" rel=\"noopener\">Rémy Ginoux</a>, une agence d'intégration IA et d'automatisation pour les TPE/PME. Ensemble, nous collaborons sur les aspects techniques et développement : workflows n8n, agents, intégrations. Rémy apporte en plus 25 ans de terrain industriel et la vision business. Mon engagement entrepreneurial est reconnu par le <strong>Statut National Étudiant-Entrepreneur (SNEE)</strong>, dispositif PEPITE du ministère de l'Enseignement supérieur.":
        "Alongside my studies I co-founded <strong>OptimizIA.xyz</strong> with <a href=\"https://www.ginoux.xyz\" target=\"_blank\" rel=\"noopener\">Rémy Ginoux</a>, an AI and automation agency for small businesses and SMEs. We work together on the technical and development side: n8n workflows, agents, integrations. Rémy also brings 25 years of industrial experience and the business vision. My entrepreneurial work is officially recognised by the <strong>French National Student-Entrepreneur Status (SNEE)</strong>, part of the PEPITE programme run by the Ministry of Higher Education.",
    ...
    "SEOPlus! soumet un site à 161 points de vérification couvrant la technique, le SEO, le GEO et la sécurité, puis rend un rapport multilingue où chaque correctif est classé par priorité plutôt que listé en vrac. Il sert d'abord à qualifier un prospect avec des chiffres au lieu d'un argumentaire. C'est cet outil qui a audité ce site.":
    ...
    "SaaS d'audit SEO, GEO &amp; sécurité": "SEO, GEO &amp; security audit SaaS",
    ...
    "Moteur d'analyse de 161 points de vérification par site": "An analysis engine with 161 checks per site",
    "Rapport multilingue avec score, verdict et correctifs priorisés": "A multilingual report with a score, a verdict and prioritised fixes",
    "Accéder à SEOPlus!": "Open SEOPlus!",
    ...
    "Boîte triée à la réception, sans passage manuel": "Inbox sorted on arrival, no manual pass",
    ...
    "Prédire si une expédition atteindra le sommet avec ce que l'on sait avant le départ. Régression logistique sur 11 425 expéditions Kaggle : 69,3 % en validation croisée contre 55 % de référence, en écartant fuites de données et facteurs de confusion.":
        "Predicting whether an expedition will reach the summit from what is known before it leaves. Logistic regression on 11,425 Kaggle expeditions: 69.3% in cross-validation against a 55% baseline, while ruling out data leakage and confounding.",
    "Classification de races de chiens": "Dog breed classification",
    "Reconnaître six races du jeu Stanford Dogs. Un pipeline classique (PCA, HOG codé à la main, kNN, SVM) plafonne autour de 60 %, un transfer learning VGG16 atteint 98 % : ce sont les descripteurs qui fixent le plafond, pas le classifieur.":
        "Recognising six breeds from the Stanford Dogs dataset. A classical pipeline (PCA, hand-written HOG, kNN, SVM) plateaus around 60%, VGG16 transfer learning reaches 98%: the features set the ceiling, not the classifier.",
    "Site de location de matériel audio, vidéo et streaming, construit en 2024 à partir de la charte graphique du client, en HTML, CSS et JavaScript sans framework. Premier projet web, neuf pages, interrompu par le client en cours de route.":
        "An audio, video and streaming equipment rental site, built in 2024 from the client's brand book in plain HTML, CSS and JavaScript. A first web project, nine pages, interrupted by the client along the way.",
    ...
    /* OptimizIA */
    "<strong>OptimizIA.xyz</strong> est l'agence que j'ai co-fondée avec <a href=\"https://www.ginoux.xyz\" target=\"_blank\" rel=\"noopener\">Rémy Ginoux</a>. Nous accompagnons les dirigeants de TPE et de PME sur l'intégration de l'IA et l'automatisation de leurs processus, à Béziers et à distance partout ailleurs.":
        "<strong>OptimizIA.xyz</strong> is the agency I co-founded with <a href=\"https://www.ginoux.xyz\" target=\"_blank\" rel=\"noopener\">Rémy Ginoux</a>. We help the owners of small businesses and SMEs adopt AI and automate their processes, in Béziers and remotely everywhere else.",
    ...
    "Fais un tour sur SEOPlus!, l'outil d'audit qu'on a construit chez OptimizIA.xyz. Il analyse 161 points techniques, SEO et sécurité, et te rend un rapport avec les correctifs classés par priorité. C'est lui qui a audité ce site.":
        "Take a look at SEOPlus!, the audit tool we built at OptimizIA.xyz. It runs 161 technical, SEO and security checks and returns a report with the fixes ranked by priority. It is the tool that audited this site.",
    ...
    "Romain Ben est un étudiant ingénieur en MAM4 (Mathématiques Appliquées et Modélisation) à Polytech Nice Sophia. Il est co-fondateur de l'agence OptimizIA.xyz, spécialisée en IA et automatisation pour les TPE et PME, et titulaire du Statut National Étudiant-Entrepreneur.":
        "Romain Ben is a fourth-year engineering student in Applied Mathematics and Modelling at Polytech Nice Sophia. He is co-founder of OptimizIA.xyz, an agency specialising in AI and automation for small businesses and SMEs, and holds the French National Student-Entrepreneur Status.",
    ...
    "Un agent de veille quotidien pour un créateur de contenu (collecte multi-sources, scoring par LLM, synthèse envoyée du lundi au vendredi). Un SaaS d'audit SEO, GEO et sécurité analysant 161 points par site. Une plateforme d'abonnement avec paiement Stripe, espace client et attribution automatique des accès. Un site vitrine et son audit SEO pour une consultante RH et RSE. Un tri automatique de boîte Gmail qui signale les urgences à la réception. Un tunnel de prise de rendez-vous sur mesure, dont les créneaux sont calculés depuis les disponibilités réelles de l'agenda. Un système d'information et de pilotage de projet, qui centralise le suivi des tâches et la base de connaissance.":
        "A daily monitoring agent for a content creator (multi-source collection, LLM scoring, a digest sent Monday to Friday). An SEO, GEO and security audit SaaS running 161 checks per site. A subscription platform with Stripe payments, a client area and automatic access provisioning. A marketing site and its SEO audit for an HR and CSR consultant. Automatic Gmail inbox triage that flags urgent messages on arrival. A bespoke booking funnel whose slots are computed from real calendar availability. And an information and project-steering system that centralises task tracking and the knowledge base.",
